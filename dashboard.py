...
def get_weekly_data():
    try:
        ...
        key_map = {
            "CSAT": "csat",
            "SLA dos DS": "sla",
            "Cobertura de Carteira": "cobertura",
        ...
        for metrica in metricas:
            ...
            # Usar chave que o frontend espera (csat, sla, cobertura, churn)
            chave = key_map.get(metrica, metrica.lower().replace(" ", "_"))
            weekly_data[chave] = valores
